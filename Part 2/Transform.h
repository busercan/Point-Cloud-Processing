...
public:
	...
	//! Acı degerleriyle rotasyon matrisini olusturur
	...
	//! alınan nokta listesindeki her nokta için doTrasnform fonksiyonunu çağırır
	list<Point> doTransform(list<Point> lp);
	//! alınan nokta bulutunu nokta listesine dönüştürür ve list için doTransform fonksiyonunu cagirir.
