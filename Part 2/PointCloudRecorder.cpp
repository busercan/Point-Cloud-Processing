...
*@date December 2022
*@brief Bu fonksiyon nokta bulutlarının dosyaya kaydedilmesi için kullanılmaktadır. 
Save fonksiyonu çağrıldığında, fileName ile ismi verilen dosya açılır, 
parametre olarak verilen nokta bulutundaki noktalar bu dosyaya kaydedilir.
*/
...
//Bu fonksiyon dosya adini setlemek icin kullanilir,filename'i baska bir stringe esitler.
void PointCloudRecorder::setfileName(string _fileName) {
	fileName = _fileName;
}

//Bu fonksiyon dosya adini döndürmek icin kullanilir.
string PointCloudRecorder::getfileName() {
	return fileName;
}
//Paremetre olarak list kullanilmistir.
